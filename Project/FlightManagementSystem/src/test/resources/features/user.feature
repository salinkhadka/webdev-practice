Feature: User Management
  ...
  Scenario: Create a new user
    ...
    And the user email is "johndoe@example.com"
    And the user password is "password123"
    And the user contact number is "1234567890"
  ...
  Scenario: Update user data
    ...
    And the new user email is "janedoe@example.com"
    And the new user password is "newpassword123"
    And the new user contact number is "0987654321"
